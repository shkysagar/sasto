            ...
            if (isset($creta_Options['welcome_msg'])) {
                ...
                <a class="btn btn-secondary" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false">
                    <i class="ec ec-user"></i> <?php echo esc_attr($current_user->display_name); ?>
                </a>

                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                    <h6 class="dropdown-header">Hy, <?php echo esc_attr($current_user->display_name); ?> !</h6>

                    <?php wp_nav_menu(array(
                        'theme_location' => 'toplinks',
                        'container' => '',
                        'menu_class' => 'list-group list-group-flush' . $mcls,
                        'before' => '',
                        'after' => '',
                        'link_before' => '',
                        'link_after' => '',
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 mx-auto">
                        <h1><?php echo do_shortcode('[product_count]'); ?> Premium Bootstrap Templates & Website
                            Themes</h1>
                    </div>
                    ...
                    <div class="col-md-10 col-lg-10 col-xs-12 mx-auto">
        ...
        if (isset($creta_Options['enable_home_featured_products']) && !empty($creta_Options['enable_home_featured_products'])) {
            ...
            <section>
                <div class="container-fluid full-col">
                    <div class="row">
                        <div class="col-md-12 ">
                            <h2 class="text-center">Discover Our Featured Templates of The Month.</h2>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="item">
                                            <div class="item-inner">
                                                ...
                                                <?php if ($product->is_on_sale() && $product->product_type == 'simple') : ?>
                                                    ...
                                                    <div class="item-img-info bubble">
                                                        <?php
                                                ...
                                                <?php endif; ?>
                                                <div class="item-img-info item-cat">
                                                    <?php echo htmlspecialchars_decode($product->get_categories()); ?>

                                                </div>
                                                <div class="item-img-info box-hover">
                                                    <ul class="pagination">
                                                        <li class="page-item">
                                                            <?php if (class_exists('YITH_WCQV_Frontend')) { ?>
                                                                <a class="btn btn-primary btn-circle " href="#"
                                                        ...
                                                        <li class="page-item">
                                                            ...
                                                            if (isset($yith_wcwl) && is_object($yith_wcwl)) {
                                                                $classes = get_option('yith_wcwl_use_button') == 'yes' ? 'class="btn btn-primary  btn-circle "' : 'class="btn btn-primary  btn-circle "';
                                                                ?>
...
//Home multi option
if (!function_exists('magikCreta_colab_products')) {
    function magikCreta_colab_products()
    {
        global $creta_Options;
        if (isset($creta_Options['enable_home_featured_products']) && !empty($creta_Options['enable_home_featured_products'])) {
            ?>
                                ...
                                <ul class="nav justify-content-center">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                           role="tab"
                                           aria-controls="home" aria-selected="true">Feature</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact"
                                           role="tab"
                                           aria-controls="contact" aria-selected="false">Top Rated</a>
                                    </li>
                                </ul>
...
//Home multi item template
if (!function_exists('magikCreta_twoitem_template')) {
    function magikCreta_twoitem_template()
    {
...
if (!function_exists('magikCreta_hot_page_banner')) {
    function magikCreta_hot_page_banner()
    {
        global $creta_Options;
                ...
                <div class="container">
                    ...
                    <ul class="nav justify-content-center">
                        ...
                        foreach ($creta_Options['home_newproduct_categories'] as $category) {
                            ...
                            ?>
                            <li class="nav-item <?php if ($catloop == 1) { ?> active <?php } ?>">
                                <a class="nav-link" href="#newcat-<?php echo esc_html($category) ?>"
                                                            ...
                                                            <div class="item-img-info box-hover">
                                                                <ul class="pagination">
                                                                    <li class="page-item">
                                                                        <?php if (class_exists('YITH_WCQV_Frontend')) { ?>
                                                                            <a class="btn btn-primary btn-round "
                                                                               href="#"
                                                                               data-product_id="<?php echo esc_html($product->get_id()); ?>"><i
                                                                    ...
                                                                    <li class="page-item">
                                                                        <?php
                                                                        if (isset($yith_wcwl) && is_object($yith_wcwl)) {
                                                                            $classes = get_option('yith_wcwl_use_button') == 'yes' ? 'class="btn btn-primary btn-round "' : 'class="btn btn-primary btn-round "';
                                                                            ?>
                                                                            <a href="<?php echo esc_url(add_query_arg('add_to_wishlist', $product->get_id())) ?>"
                                                                               data-product-id="<?php echo esc_html($product->get_id()); ?>"
                                                                               data-product-type="<?php echo esc_html($product->get_type()); ?>" <?php echo htmlspecialchars_decode($classes); ?>
