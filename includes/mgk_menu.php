    ...
    class MagikCreta_top_navwalker extends Walker_Nav_Menu
    {
        ...
        function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            if ($depth == 1) {
                ...
                $output .= $indent . '<li id="mero nav-menu-item-' . esc_html($item->ID) . '" class="nav-item ' . $class_names . ' ' . $active . $sub . $menu_type . $popup_pos . $popup_cols . '" data-cols="' . $cols . '"' . $sub_popup_style . '>';
            } else {
