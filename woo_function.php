    ...
    <script type="text/javascript">
        jQuery('.timer-grid').each(function () {
            ...
            jQuery(this).countdown(countTime, function (event) {
                jQuery(this).html('<div class="day box-time-date"><span class="number">' + event.strftime('%D') + ' </span><?php esc_html_e('days', 'creta');?></div> <div class="hour box-time-date"><span class="number">' + event.strftime('%H') + '</span><?php esc_html_e('hrs', 'creta');?></div><div class="min box-time-date"><span class="number">' + event.strftime('%M') + '</span> <?php esc_html_e('mins', 'creta');?></div> <div class="sec box-time-date"><span class="number">' + event.strftime('%S') + ' </span><?php esc_html_e('sec', 'creta');?></div>')
            });
